...
int Number_Each_Colour[6];                     //used to count the number of each colour and be the index of colour deck
...
int CheckCardsNumbers(int sameordifer)              //check if they are the same quantity of cards
{
	for (int i = 1; i < 6; i++)                     //use blue number compare with other numbers
	{
...
void CheckCardsValues()                                  //check cards values and output
{
	...
	SameOrDifer=CheckCardsNumbers(SameOrDifer);     
