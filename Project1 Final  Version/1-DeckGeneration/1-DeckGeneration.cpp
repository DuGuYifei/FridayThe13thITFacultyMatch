...
void EstimateValue(int valuek, int valueg, int valuegv, int valueo)  //estimate whether the value exceed the requirement
{
...
int main()
{
	std::cin >> k >> g >> gv >> o;         //input the first line 

	EstimateValue(k, g, gv, o);       //as the requirement, input the value in right domain, if is is wrong, you can input again
